...
(function($) {
	...
	$.fn.jshowoff = function(settings) {
		...
		var config = {
			...
			controls : true,
			controlText : {
				play :		'<img src="img/sliderplay.jpg" border="0"/>',
				pause :		'<img src="img/sliderpause.jpg" border="0"/>',
				next :		'<img src="img/slidernext.jpg" border="0"/>',
				previous :	'<img src="img/sliderback.jpg" border="0"/>'
			},
			effect : 'none',
			hoverPause : false,
			links : false,
